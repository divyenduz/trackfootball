    ...
    <>
      ...
      <article className="legal-content">
        ...
        <p>
          ...
          shared and/or collect in https://trackfootball.app. This policy is not
        ...
        <p>
          https://trackfootball.app follows a standard procedure of using log
        ...
        <p>
          Like any other website, https://trackfootball.app uses
        ...
        <p>
          ...
          advertising partners of https://trackfootball.app.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on https://trackfootball.app,
        ...
        <p>
          Note that https://trackfootball.app has no access to or control over
        ...
        <p>
          https://trackfootball.app&apos;s Privacy Policy does not apply to
        ...
        <p>
          https://trackfootball.app does not knowingly collect any Personal
