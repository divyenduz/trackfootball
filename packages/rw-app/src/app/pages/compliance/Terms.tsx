  ...
  return (
    <>
      ...
      <article className="legal-content">
        ...
        <p>
          By accessing this Website, accessible from https://trackfootball.app,
        ...
        <p>
          ...
          materials on TrackFootball&apos;s Website for personal, non-commercial
        ...
        <p>
          This will let TrackFootball to terminate upon violations of any of
        ...
        <p>
          All the materials on TrackFootball’s Website are provided &quot;as
          is&quot;. TrackFootball makes no warranties, may it be expressed or
          implied, therefore negates all other warranties. Furthermore,
          TrackFootball does not make any representations concerning the
        ...
        <p>
          TrackFootball or its suppliers will not be hold accountable for any
          damages that will arise with the use or inability to use the materials
          on TrackFootball’s Website, even if TrackFootball or an authorize
        ...
        <p>
          The materials appearing on TrackFootball’s Website may include
          technical, typographical, or photographic errors. TrackFootball will
          not promise that any of the materials in this Website are accurate,
          complete, or current. TrackFootball may change the materials contained
          on its Website at any time without notice. TrackFootball does not make
        ...
        <p>
          TrackFootball has not reviewed all of the sites linked to its Website
          and is not responsible for the contents of any such linked site. The
          presence of any link does not imply endorsement by TrackFootball of
        ...
        <p>
          TrackFootball may revise these Terms of Use for its Website at any
